    ...
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.dropdownContainer}>
          ...
          >
            <Text style={[styles.dropdownButtonText, !selectedCategory && styles.placeholder]}>
              ...
              <View style={styles.modalContent}>
                ...
                >
                  {categories.map((category) => {
                    const iconData = TransactionCategories.CATEGORY_ICONS[category as keyof typeof TransactionCategories.CATEGORY_ICONS];
                    return (
                      <TouchableOpacity
                        key={category}
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={[styles.button, styles.incomeButton, isSubmitting && styles.disabledButton]}
          ...
          <TouchableOpacity
            style={[styles.button, styles.expenseButton, isSubmitting && styles.disabledButton]}
